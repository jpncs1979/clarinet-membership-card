...
const { MEMBERS_FILE: DEFAULT_MEMBERS_FILE } = require('./membersDataPath');
const { stableMemberId } = require('./stableMemberId');
...
/**
 * CSVファイルを読み込み、会員データ JSON（lib/membersDataPath.js のパス）を更新します。
